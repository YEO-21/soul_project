...
public class DrawGizmoLineInfo
{
    ...
    /// 감지되었을 경우 설정시킬 색상
    /// </summary>
    public Color dectededColor { get; set; } = new Color(1.0f, 0.0f, 0.0f, 1.0f);
    ...
    /// </summary>
    public Color drawColor => isHit ? dectededColor : defaultColor;
}
...
public static class PhysicsExt
{
        ...
        QueryTriggerInteraction queryTriggerInteraction = QueryTriggerInteraction.UseGlobal)
    {
        ...
        bool result = Physics.Raycast(ray,
            out hitInfo,
            maxDistance,
            layerMask,
